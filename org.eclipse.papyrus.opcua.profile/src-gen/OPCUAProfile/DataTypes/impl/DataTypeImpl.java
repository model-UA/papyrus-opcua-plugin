 ...
 * </p>
 * <ul>
 *   <li>{@link OPCUAProfile.DataTypes.impl.DataTypeImpl#getIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link OPCUAProfile.DataTypes.impl.DataTypeImpl#getBase_Class <em>Base Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataTypeImpl extends BaseNodeClassImpl implements DataType {
	...
	public org.eclipse.uml2.uml.Class getBase_Class() {
		if (base_Class != null && base_Class.eIsProxy()) {
			...
			if (base_Class != oldBase_Class) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DataTypesPackage.DATA_TYPE__BASE_CLASS, oldBase_Class, base_Class));
			}
		}
		return base_Class;
	}
	...
	public void setBase_Class(org.eclipse.uml2.uml.Class newBase_Class) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataTypesPackage.DATA_TYPE__BASE_CLASS, oldBase_Class, base_Class));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DataTypesPackage.DATA_TYPE__BASE_CLASS:
