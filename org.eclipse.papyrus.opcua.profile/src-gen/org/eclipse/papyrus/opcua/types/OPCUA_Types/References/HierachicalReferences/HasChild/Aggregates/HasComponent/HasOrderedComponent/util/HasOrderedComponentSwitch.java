 ...
 * @generated
 */
public class HasOrderedComponentSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public HasOrderedComponentSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HasOrderedComponentPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasOrderedComponentPackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasOrderedComponentPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasOrderedComponentPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasOrderedComponentPackage.HAS_ORDERED_COMPONENT: {
				HasOrderedComponent hasOrderedComponent = (HasOrderedComponent)theEObject;
				T result = caseHasOrderedComponent(hasOrderedComponent);
				if (result == null) result = caseHasComponent(hasOrderedComponent);
				if (result == null) result = caseAggregates(hasOrderedComponent);
				if (result == null) result = caseHasChild(hasOrderedComponent);
				if (result == null) result = caseHierachicalReferences(hasOrderedComponent);
				if (result == null) result = caseReferences(hasOrderedComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Has Ordered Component</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Has Ordered Component</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHasOrderedComponent(HasOrderedComponent object) {
		return null;
	}
