 ...
 * @generated
 */
public class HasEffectSuppressedSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public HasEffectSuppressedSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HasEffectSuppressedPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasEffectSuppressedPackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasEffectSuppressedPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasEffectSuppressedPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasEffectSuppressedPackage.HAS_EFFECT_SUPPRESSED: {
				HasEffectSuppressed hasEffectSuppressed = (HasEffectSuppressed)theEObject;
				T result = caseHasEffectSuppressed(hasEffectSuppressed);
				if (result == null) result = caseHasEffect(hasEffectSuppressed);
				if (result == null) result = caseHierachicalReferences(hasEffectSuppressed);
				if (result == null) result = caseReferences(hasEffectSuppressed);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Has Effect Suppressed</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Has Effect Suppressed</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHasEffectSuppressed(HasEffectSuppressed object) {
		return null;
	}
