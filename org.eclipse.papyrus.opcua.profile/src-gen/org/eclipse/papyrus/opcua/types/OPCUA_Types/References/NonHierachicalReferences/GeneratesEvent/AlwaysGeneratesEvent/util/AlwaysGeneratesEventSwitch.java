 ...
 * @generated
 */
public class AlwaysGeneratesEventSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public AlwaysGeneratesEventSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AlwaysGeneratesEventPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AlwaysGeneratesEventPackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AlwaysGeneratesEventPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AlwaysGeneratesEventPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AlwaysGeneratesEventPackage.ALWAYS_GENERATES_EVENT: {
				AlwaysGeneratesEvent alwaysGeneratesEvent = (AlwaysGeneratesEvent)theEObject;
				T result = caseAlwaysGeneratesEvent(alwaysGeneratesEvent);
				if (result == null) result = caseGeneratesEvent(alwaysGeneratesEvent);
				if (result == null) result = caseHierachicalReferences(alwaysGeneratesEvent);
				if (result == null) result = caseReferences(alwaysGeneratesEvent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Always Generates Event</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Always Generates Event</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAlwaysGeneratesEvent(AlwaysGeneratesEvent object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Generates Event</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Generates Event</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseGeneratesEvent(GeneratesEvent object) {
		return null;
	}
