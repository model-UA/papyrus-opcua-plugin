 ...
 * </p>
 * <ul>
 *   <li>{@link org.opcfoundation.ua._2011._03.ua.UANodeSet.impl.UAViewImpl#isContainsNoLoops <em>Contains No Loops</em>}</li>
 *   <li>{@link org.opcfoundation.ua._2011._03.ua.UANodeSet.impl.UAViewImpl#getEventNotifier <em>Event Notifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UAViewImpl extends UAInstanceImpl implements UAView {
	...
	protected EClass eStaticClass() {
		return NodeSetPackage.Literals.UA_VIEW;
	}
	...
	public void setContainsNoLoops(boolean newContainsNoLoops) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NodeSetPackage.UA_VIEW__CONTAINS_NO_LOOPS, oldContainsNoLoops, containsNoLoops, !oldContainsNoLoopsESet));
	}
	...
	public void unsetContainsNoLoops() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, NodeSetPackage.UA_VIEW__CONTAINS_NO_LOOPS, oldContainsNoLoops, CONTAINS_NO_LOOPS_EDEFAULT, oldContainsNoLoopsESet));
	}
	...
	public void setEventNotifier(short newEventNotifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NodeSetPackage.UA_VIEW__EVENT_NOTIFIER, oldEventNotifier, eventNotifier, !oldEventNotifierESet));
	}
	...
	public void unsetEventNotifier() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, NodeSetPackage.UA_VIEW__EVENT_NOTIFIER, oldEventNotifier, EVENT_NOTIFIER_EDEFAULT, oldEventNotifierESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NodeSetPackage.UA_VIEW__CONTAINS_NO_LOOPS:
				return isContainsNoLoops();
			case NodeSetPackage.UA_VIEW__EVENT_NOTIFIER:
