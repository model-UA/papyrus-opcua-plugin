 ...
 * @generated
 */
public class NonHierachicalReferencesSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public NonHierachicalReferencesSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NonHierachicalReferencesPackage.NON_HIERACHICAL_REFERENCES: {
				NonHierachicalReferences nonHierachicalReferences = (NonHierachicalReferences)theEObject;
				T result = caseNonHierachicalReferences(nonHierachicalReferences);
				if (result == null) result = caseReferences(nonHierachicalReferences);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NonHierachicalReferencesPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NonHierachicalReferencesPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NonHierachicalReferencesPackage.BROWSE_NAME: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Non Hierachical References</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Non Hierachical References</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNonHierachicalReferences(NonHierachicalReferences object) {
		return null;
	}
...
} //NonHierachicalReferencesSwitch
