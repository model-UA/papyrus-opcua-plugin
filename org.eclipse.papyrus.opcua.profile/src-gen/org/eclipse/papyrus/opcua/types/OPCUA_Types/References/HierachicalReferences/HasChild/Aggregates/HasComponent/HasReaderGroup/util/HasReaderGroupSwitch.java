 ...
 * @generated
 */
public class HasReaderGroupSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HasReaderGroupPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasReaderGroupPackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasReaderGroupPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasReaderGroupPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasReaderGroupPackage.HAS_READER_GROUP: {
				HasReaderGroup hasReaderGroup = (HasReaderGroup)theEObject;
				T result = caseHasReaderGroup(hasReaderGroup);
				if (result == null) result = caseHasComponent(hasReaderGroup);
				if (result == null) result = caseAggregates(hasReaderGroup);
				if (result == null) result = caseHasChild(hasReaderGroup);
				if (result == null) result = caseHierachicalReferences(hasReaderGroup);
				if (result == null) result = caseReferences(hasReaderGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Has Reader Group</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Has Reader Group</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHasReaderGroup(HasReaderGroup object) {
		return null;
	}
