 ...
 * @generated
 */
public class HasArgumentDescriptionSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public HasArgumentDescriptionSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HasArgumentDescriptionPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasArgumentDescriptionPackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasArgumentDescriptionPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasArgumentDescriptionPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasArgumentDescriptionPackage.HAS_ARGUMENT_DESCRIPTION: {
				HasArgumentDescription hasArgumentDescription = (HasArgumentDescription)theEObject;
				T result = caseHasArgumentDescription(hasArgumentDescription);
				if (result == null) result = caseHasComponent(hasArgumentDescription);
				if (result == null) result = caseAggregates(hasArgumentDescription);
				if (result == null) result = caseHasChild(hasArgumentDescription);
				if (result == null) result = caseHierachicalReferences(hasArgumentDescription);
				if (result == null) result = caseReferences(hasArgumentDescription);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
