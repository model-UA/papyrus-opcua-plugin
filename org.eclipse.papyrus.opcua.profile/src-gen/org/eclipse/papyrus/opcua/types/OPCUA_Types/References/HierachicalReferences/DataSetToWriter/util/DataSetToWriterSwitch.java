/**
 */
package org.eclipse.papyrus.opcua.types.OPCUA_Types.References.HierachicalReferences.DataSetToWriter.util;
 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.papyrus.opcua.types.OPCUA_Types.References.HierachicalReferences.DataSetToWriter.DataSetToWriterPackage
 * @generated
 */
public class DataSetToWriterSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static DataSetToWriterPackage modelPackage;
	 ...
	 * @generated
	 */
	public DataSetToWriterSwitch() {
		if (modelPackage == null) {
			modelPackage = DataSetToWriterPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DataSetToWriterPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataSetToWriterPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataSetToWriterPackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataSetToWriterPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataSetToWriterPackage.DATA_SET_TO_WRITER: {
				DataSetToWriter dataSetToWriter = (DataSetToWriter)theEObject;
				T result = caseDataSetToWriter(dataSetToWriter);
				if (result == null) result = caseHierachicalReferences(dataSetToWriter);
				if (result == null) result = caseReferences(dataSetToWriter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Data Set To Writer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Data Set To Writer</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDataSetToWriter(DataSetToWriter object) {
		return null;
	}
