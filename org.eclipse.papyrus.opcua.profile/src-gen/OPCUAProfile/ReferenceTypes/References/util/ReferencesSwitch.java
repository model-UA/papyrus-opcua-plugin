/**
 */
package OPCUAProfile.ReferenceTypes.References.util;
 ...
 * <!-- end-user-doc -->
 * @see OPCUAProfile.ReferenceTypes.References.ReferencesPackage
 * @generated
 */
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ReferencesPackage.REFERENCE_TYPE: {
				...
				if (result == null) result = caseBaseNodeClass(referenceType);
