 ...
 * @generated
 */
public class HasTypeDefinitionSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public HasTypeDefinitionSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HasTypeDefinitionPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasTypeDefinitionPackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasTypeDefinitionPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasTypeDefinitionPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasTypeDefinitionPackage.HAS_TYPE_DEFINITION: {
				HasTypeDefinition hasTypeDefinition = (HasTypeDefinition)theEObject;
				T result = caseHasTypeDefinition(hasTypeDefinition);
				if (result == null) result = caseHierachicalReferences(hasTypeDefinition);
				if (result == null) result = caseReferences(hasTypeDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Has Type Definition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Has Type Definition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHasTypeDefinition(HasTypeDefinition object) {
		return null;
	}
