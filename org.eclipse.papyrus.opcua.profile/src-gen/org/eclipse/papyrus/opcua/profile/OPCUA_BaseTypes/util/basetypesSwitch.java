 ...
 * @generated
 */
public class basetypesSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case basetypesPackage.OBJECT_TYPE: {
			...
			case basetypesPackage.OBJECT: {
				org.eclipse.papyrus.opcua.profile.OPCUA_BaseTypes.Object object = (org.eclipse.papyrus.opcua.profile.OPCUA_BaseTypes.Object)theEObject;
				T result = caseObject(object);
				if (result == null) result = caseBaseNodeClass(object);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case basetypesPackage.METHOD: {
			...
			case basetypesPackage.VARIABLE_TYPE: {
			...
			case basetypesPackage.REFERENCE_TYPE: {
			...
			case basetypesPackage.INFORMATION_MODEL: {
				...
				if (result == null) result = caseStereotype(informationModel);
				if (result == null) result = caseClass(informationModel);
				if (result == null) result = caseEncapsulatedClassifier(informationModel);
				if (result == null) result = caseBehavioredClassifier(informationModel);
				if (result == null) result = caseStructuredClassifier(informationModel);
				if (result == null) result = caseClassifier(informationModel);
				if (result == null) result = caseNamespace(informationModel);
				if (result == null) result = caseRedefinableElement(informationModel);
				if (result == null) result = caseType(informationModel);
				if (result == null) result = caseTemplateableElement(informationModel);
				if (result == null) result = casePackageableElement(informationModel);
				if (result == null) result = caseNamedElement(informationModel);
				if (result == null) result = caseParameterableElement(informationModel);
				if (result == null) result = caseElement(informationModel);
				if (result == null) result = caseEModelElement(informationModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseObject(org.eclipse.papyrus.opcua.profile.OPCUA_BaseTypes.Object object) {
		return null;
	}
