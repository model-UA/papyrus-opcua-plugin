 ...
 * </p>
 * <ul>
 *   <li>{@link org.opcfoundation.ua._2011._03.ua.UANodeSet.impl.UATypeImpl#isIsAbstract <em>Is Abstract</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UATypeImpl extends UANodeImpl implements UAType {
	...
	protected EClass eStaticClass() {
		return NodeSetPackage.Literals.UA_TYPE;
	}
	...
	public void setIsAbstract(boolean newIsAbstract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NodeSetPackage.UA_TYPE__IS_ABSTRACT, oldIsAbstract, isAbstract, !oldIsAbstractESet));
	}
	...
	public void unsetIsAbstract() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, NodeSetPackage.UA_TYPE__IS_ABSTRACT, oldIsAbstract, IS_ABSTRACT_EDEFAULT, oldIsAbstractESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NodeSetPackage.UA_TYPE__IS_ABSTRACT:
				return isIsAbstract();
		}
