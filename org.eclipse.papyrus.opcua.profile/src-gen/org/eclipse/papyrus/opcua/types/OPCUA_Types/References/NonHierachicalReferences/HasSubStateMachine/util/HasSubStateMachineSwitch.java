 ...
 * @generated
 */
public class HasSubStateMachineSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public HasSubStateMachineSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HasSubStateMachinePackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasSubStateMachinePackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasSubStateMachinePackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasSubStateMachinePackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasSubStateMachinePackage.HAS_SUB_STATE_MACHINE: {
				HasSubStateMachine hasSubStateMachine = (HasSubStateMachine)theEObject;
				T result = caseHasSubStateMachine(hasSubStateMachine);
				if (result == null) result = caseHierachicalReferences(hasSubStateMachine);
				if (result == null) result = caseReferences(hasSubStateMachine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Has Sub State Machine</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Has Sub State Machine</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHasSubStateMachine(HasSubStateMachine object) {
		return null;
	}
