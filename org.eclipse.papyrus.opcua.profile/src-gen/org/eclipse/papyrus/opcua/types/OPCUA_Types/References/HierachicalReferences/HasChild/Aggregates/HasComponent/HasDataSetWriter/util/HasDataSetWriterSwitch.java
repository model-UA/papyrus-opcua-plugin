 ...
 * @generated
 */
public class HasDataSetWriterSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HasDataSetWriterPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasDataSetWriterPackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasDataSetWriterPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasDataSetWriterPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasDataSetWriterPackage.HAS_DATA_SET_WRITER: {
				HasDataSetWriter hasDataSetWriter = (HasDataSetWriter)theEObject;
				T result = caseHasDataSetWriter(hasDataSetWriter);
				if (result == null) result = caseHasComponent(hasDataSetWriter);
				if (result == null) result = caseAggregates(hasDataSetWriter);
				if (result == null) result = caseHasChild(hasDataSetWriter);
				if (result == null) result = caseHierachicalReferences(hasDataSetWriter);
				if (result == null) result = caseReferences(hasDataSetWriter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Has Data Set Writer</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Has Data Set Writer</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHasDataSetWriter(HasDataSetWriter object) {
		return null;
	}
