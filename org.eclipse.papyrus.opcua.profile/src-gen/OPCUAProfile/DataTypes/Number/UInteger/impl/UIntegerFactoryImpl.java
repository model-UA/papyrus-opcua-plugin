...
import OPCUAProfile.DataTypes.Number.UInteger.*;
 ...
 * @generated
 */
public class UIntegerFactoryImpl extends EFactoryImpl implements UIntegerFactory {
	/**
	 ...
	 * @generated
	 */
	public static UIntegerFactory init() {
		try {
			UIntegerFactory theUIntegerFactory = (UIntegerFactory)EPackage.Registry.INSTANCE.getEFactory(UIntegerPackage.eNS_URI);
			if (theUIntegerFactory != null) {
				return theUIntegerFactory;
			}
		}
		catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new UIntegerFactoryImpl();
	}
	 ...
	 * @generated
	 */
	public Short createUInt16FromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public Integer createUInt32FromString(EDataType eDataType, String initialValue) {
	 ...
	 * @generated
	 */
	public UIntegerPackage getUIntegerPackage() {
		return (UIntegerPackage)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static UIntegerPackage getPackage() {
		return UIntegerPackage.eINSTANCE;
	}
