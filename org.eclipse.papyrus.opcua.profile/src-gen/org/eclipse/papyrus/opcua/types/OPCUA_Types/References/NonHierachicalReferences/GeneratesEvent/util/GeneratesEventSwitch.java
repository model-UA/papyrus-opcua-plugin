 ...
 * @generated
 */
public class GeneratesEventSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GeneratesEventPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GeneratesEventPackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GeneratesEventPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GeneratesEventPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GeneratesEventPackage.GENERATES_EVENT: {
				GeneratesEvent generatesEvent = (GeneratesEvent)theEObject;
				T result = caseGeneratesEvent(generatesEvent);
				if (result == null) result = caseHierachicalReferences(generatesEvent);
				if (result == null) result = caseReferences(generatesEvent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
