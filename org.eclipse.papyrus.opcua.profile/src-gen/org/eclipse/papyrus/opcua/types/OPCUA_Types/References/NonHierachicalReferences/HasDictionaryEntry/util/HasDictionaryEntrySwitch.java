 ...
 * @generated
 */
public class HasDictionaryEntrySwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public HasDictionaryEntrySwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HasDictionaryEntryPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasDictionaryEntryPackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasDictionaryEntryPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasDictionaryEntryPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasDictionaryEntryPackage.HAS_DICTIONARY_ENTRY: {
				HasDictionaryEntry hasDictionaryEntry = (HasDictionaryEntry)theEObject;
				T result = caseHasDictionaryEntry(hasDictionaryEntry);
				if (result == null) result = caseHierachicalReferences(hasDictionaryEntry);
				if (result == null) result = caseReferences(hasDictionaryEntry);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Has Dictionary Entry</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Has Dictionary Entry</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHasDictionaryEntry(HasDictionaryEntry object) {
		return null;
	}
