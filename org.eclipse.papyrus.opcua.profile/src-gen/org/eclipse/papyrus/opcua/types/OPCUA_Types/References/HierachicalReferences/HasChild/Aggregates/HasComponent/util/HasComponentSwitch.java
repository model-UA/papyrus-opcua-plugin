 ...
 * @generated
 */
public class HasComponentSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HasComponentPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasComponentPackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasComponentPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasComponentPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasComponentPackage.HAS_COMPONENT: {
				HasComponent hasComponent = (HasComponent)theEObject;
				T result = caseHasComponent(hasComponent);
				if (result == null) result = caseAggregates(hasComponent);
				if (result == null) result = caseHasChild(hasComponent);
				if (result == null) result = caseHierachicalReferences(hasComponent);
				if (result == null) result = caseReferences(hasComponent);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
