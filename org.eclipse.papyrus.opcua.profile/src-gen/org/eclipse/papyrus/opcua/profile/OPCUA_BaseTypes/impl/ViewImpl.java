 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.papyrus.opcua.profile.OPCUA_BaseTypes.impl.ViewImpl#isContainsNoLoops <em>Contains No Loops</em>}</li>
 *   <li>{@link org.eclipse.papyrus.opcua.profile.OPCUA_BaseTypes.impl.ViewImpl#getEventNotifier <em>Event Notifier</em>}</li>
 *   <li>{@link org.eclipse.papyrus.opcua.profile.OPCUA_BaseTypes.impl.ViewImpl#getBase_Class <em>Base Class</em>}</li>
 *   <li>{@link org.eclipse.papyrus.opcua.profile.OPCUA_BaseTypes.impl.ViewImpl#getBase_Stereotype <em>Base Stereotype</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ViewImpl extends BaseNodeClassImpl implements View {
	...
	protected EClass eStaticClass() {
		return basetypesPackage.Literals.VIEW;
	}
	...
	public void setContainsNoLoops(boolean newContainsNoLoops) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, basetypesPackage.VIEW__CONTAINS_NO_LOOPS, oldContainsNoLoops, containsNoLoops));
	}
	...
	public void setEventNotifier(byte newEventNotifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, basetypesPackage.VIEW__EVENT_NOTIFIER, oldEventNotifier, eventNotifier));
	}
	...
	public org.eclipse.uml2.uml.Class getBase_Class() {
		if (base_Class != null && base_Class.eIsProxy()) {
			...
			if (base_Class != oldBase_Class) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, basetypesPackage.VIEW__BASE_CLASS, oldBase_Class, base_Class));
			}
		}
		return base_Class;
	}
	...
	public void setBase_Class(org.eclipse.uml2.uml.Class newBase_Class) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, basetypesPackage.VIEW__BASE_CLASS, oldBase_Class, base_Class));
	}
	...
	public Stereotype getBase_Stereotype() {
		if (base_Stereotype != null && base_Stereotype.eIsProxy()) {
			...
			if (base_Stereotype != oldBase_Stereotype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, basetypesPackage.VIEW__BASE_STEREOTYPE, oldBase_Stereotype, base_Stereotype));
			}
		}
	...
	public void setBase_Stereotype(Stereotype newBase_Stereotype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, basetypesPackage.VIEW__BASE_STEREOTYPE, oldBase_Stereotype, base_Stereotype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case basetypesPackage.VIEW__CONTAINS_NO_LOOPS:
				return isContainsNoLoops();
			case basetypesPackage.VIEW__EVENT_NOTIFIER:
				return getEventNotifier();
			case basetypesPackage.VIEW__BASE_CLASS:
				if (resolve) return getBase_Class();
				return basicGetBase_Class();
			case basetypesPackage.VIEW__BASE_STEREOTYPE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case basetypesPackage.VIEW__CONTAINS_NO_LOOPS:
				return containsNoLoops != CONTAINS_NO_LOOPS_EDEFAULT;
			case basetypesPackage.VIEW__EVENT_NOTIFIER:
