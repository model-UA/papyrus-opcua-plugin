/**
 */
package org.eclipse.papyrus.opcua.types.OPCUA_Types.References.HierachicalReferences.HasChild.Aggregates.HasComponent.HasGuard.util;
 ...
 * @generated
 */
public class HasGuardSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static HasGuardPackage modelPackage;
	 ...
	 * @generated
	 */
	public HasGuardSwitch() {
		if (modelPackage == null) {
			modelPackage = HasGuardPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HasGuardPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasGuardPackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasGuardPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasGuardPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasGuardPackage.HAS_GUARD: {
				HasGuard hasGuard = (HasGuard)theEObject;
				T result = caseHasGuard(hasGuard);
				if (result == null) result = caseHasComponent(hasGuard);
				if (result == null) result = caseAggregates(hasGuard);
				if (result == null) result = caseHasChild(hasGuard);
				if (result == null) result = caseHierachicalReferences(hasGuard);
				if (result == null) result = caseReferences(hasGuard);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Has Guard</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Has Guard</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHasGuard(HasGuard object) {
		return null;
	}
