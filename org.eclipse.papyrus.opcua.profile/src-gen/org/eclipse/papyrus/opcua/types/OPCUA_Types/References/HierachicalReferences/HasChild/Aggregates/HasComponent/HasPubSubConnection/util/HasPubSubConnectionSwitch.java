 ...
 * @generated
 */
public class HasPubSubConnectionSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public HasPubSubConnectionSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HasPubSubConnectionPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasPubSubConnectionPackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasPubSubConnectionPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasPubSubConnectionPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasPubSubConnectionPackage.HAS_PUB_SUB_CONNECTION: {
				HasPubSubConnection hasPubSubConnection = (HasPubSubConnection)theEObject;
				T result = caseHasPubSubConnection(hasPubSubConnection);
				if (result == null) result = caseHasComponent(hasPubSubConnection);
				if (result == null) result = caseAggregates(hasPubSubConnection);
				if (result == null) result = caseHasChild(hasPubSubConnection);
				if (result == null) result = caseHierachicalReferences(hasPubSubConnection);
				if (result == null) result = caseReferences(hasPubSubConnection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Has Pub Sub Connection</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Has Pub Sub Connection</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHasPubSubConnection(HasPubSubConnection object) {
		return null;
	}
