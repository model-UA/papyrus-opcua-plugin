 ...
 * @generated
 */
public class HierachicalReferencesSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public HierachicalReferencesSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HierachicalReferencesPackage.HIERACHICAL_REFERENCES: {
				HierachicalReferences hierachicalReferences = (HierachicalReferences)theEObject;
				T result = caseHierachicalReferences(hierachicalReferences);
				if (result == null) result = caseReferences(hierachicalReferences);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HierachicalReferencesPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HierachicalReferencesPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HierachicalReferencesPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HierachicalReferencesPackage.BROWSE_NAME: {
