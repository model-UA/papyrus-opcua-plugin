 ...
 * @generated
 */
public class HasHistoricalConfigurationSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public HasHistoricalConfigurationSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HasHistoricalConfigurationPackage.INVERSE_NAME: {
				InverseName inverseName = (InverseName)theEObject;
				T result = caseInverseName(inverseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasHistoricalConfigurationPackage.BROWSE_NAME: {
				BrowseName browseName = (BrowseName)theEObject;
				T result = caseBrowseName(browseName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasHistoricalConfigurationPackage.DISPLAY_NAME: {
				DisplayName displayName = (DisplayName)theEObject;
				T result = caseDisplayName(displayName);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasHistoricalConfigurationPackage.NODE_ID: {
				NodeId nodeId = (NodeId)theEObject;
				T result = caseNodeId(nodeId);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HasHistoricalConfigurationPackage.HAS_HISTORICAL_CONFIGURATION: {
				HasHistoricalConfiguration hasHistoricalConfiguration = (HasHistoricalConfiguration)theEObject;
				T result = caseHasHistoricalConfiguration(hasHistoricalConfiguration);
				if (result == null) result = caseAggregates(hasHistoricalConfiguration);
				if (result == null) result = caseHasChild(hasHistoricalConfiguration);
				if (result == null) result = caseHierachicalReferences(hasHistoricalConfiguration);
				if (result == null) result = caseReferences(hasHistoricalConfiguration);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Has Historical Configuration</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Has Historical Configuration</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHasHistoricalConfiguration(HasHistoricalConfiguration object) {
		return null;
	}
...
} //HasHistoricalConfigurationSwitch
